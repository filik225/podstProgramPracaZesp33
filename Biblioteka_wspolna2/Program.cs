...
namespace BibliotekaKonsolowa
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            library.Add(new Book { Title = "Wiedźmin", Author = "Andrzej Sapkowski", Year = 1993 });
            library.Add(new Book { Title = "Hobbit", Author = "J.R.R. Tolkien", Year = 1937 });
        ...
        {
            Console.WriteLine("Sortuj według: 1.Tytułu, 2.Autora, 3.Roku");
